...
public class ChannelService {
    ...
    @Autowired
    public ChannelService(ChannelRepository channelRepository, ChatMemberRepository chatMemberRepository) {
    ...
    public boolean isOwner(int chatId, String username) {
        ...
        for(ChatMember member: members){
            if(member.getMemberType() == ChatMemberType.OWNER && member.getUser().equals(username)){
                return true;
            }
        }
        return false;
